    ...
    <div class="card-header">
        ...
        <div class="card-toolbar">
            ...
            {{-- <button class="btn btn-primary btn-sm me-2" data-bs-toggle="modal"
                    ...
                    Data</button> --}}
                    <a href="{{route('pengguna.add')}}" class="btn btn-primary btn-sm me-2"><i class="fa fa-plus-circle"></i>Tambah Pengguna</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="d-flex justify-content-end" data-kt-data-table-toolbar="base">
                ...
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px"
                    ...
                    <div class="px-7 py-5" data-kt-data-table-filter="form">
                        <!--begin::Input group-->
                        <div class="mb-10">
                            <label class="form-label fs-6 fw-bold">Role :
                            </label>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datas_table">
            ...
            <thead>
                ...
                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    {{-- <th class="min-w-200px">ID_Pengguan</th> --}}
                ...
                <tr>
                    ...
                    <td class="d-flex text-start">
                        {{-- <button class="btn btn-warning btn-sm me-2"
                            ...
                            <a href="{{route('pengguna.edit')}}" class="btn btn-warning btn-sm me-2"> <i class="fa fa-edit"></i>
                                <span class="d-none d-lg-inline">Update</span></a>
                        </button>
