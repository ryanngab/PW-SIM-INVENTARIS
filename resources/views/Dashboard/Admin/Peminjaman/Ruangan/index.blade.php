...
<div class="card card-flush border border-primary mb-5 mt-xl-9">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            ...
            <a href="{{route('peminjamanRuangan.add')}}" class="btn btn-primary btn-sm me-2"><i class="fa fa-plus-circle"></i>Tambah
                    Data</a>
            </div>
        </div>
    </div>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datas_table">
            ...
            <thead>
                ...
                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-200px">Nomor Ruangan</th>
                    <th class="min-w-125px">ID Ruangan</th>
                    <th class="min-w-150px">Nama Gedung</th>
                    <th class="min-w-200px">Status Ruangan</th>
